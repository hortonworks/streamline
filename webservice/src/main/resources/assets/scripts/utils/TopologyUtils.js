    	...
    	switch(currentType){
            ...
            case 'CUSTOM':
    			...
    			if(index !== -1){
                    ...
                    if(currentType === 'CUSTOM' || currentType === 'RULE'){
                        _.each(parent.processorArr, function(obj){
                            if(obj.currentType === 'RULE'){
                                var rules = obj.newConfig ? obj.newConfig.rulesProcessorConfig.rules : (obj.rulesProcessorConfig ? obj.rulesProcessorConfig.rules : []);
                                if(rules){
