  ...
  validate() {
    ...
    if (name !== '' && fileJar !== '' && version !== '') {
      ...
      (this.state.version.length === 0)
        ? this.version.setAttribute('class', "form-control error")
        : this.version.setAttribute('class', "form-control");
      (this.state.fileJar.length === 0)
        ? this.refs.fileJar.setAttribute('class', "form-control error")
        : this.refs.fileJar.setAttribute('class', "form-control");
      return false;
    }
  }
      ...
      <form className="form-horizontal">
        <div className="form-group">
          ...
          <div className="col-sm-12">
            <input ref={(ref) => this.nameRef = ref} name="name" placeholder="Name" onChange={this.handleValueChange.bind(this)} type="text" className="form-control" value={this.state.name} required={true}/>
          </div>
          {/*this.state.name === '' ?
        ...
        <div className="form-group">
          ...
          <div className="col-sm-12">
            <input name="storedFileName" type="file" accept=".jar" placeholder="Select Jar" className="form-control" ref="fileJar" onChange={(event) => {
              this.handleInputChange.call(this, event);
            }} required={true}/>
          </div>
          {/*this.state.fileJar === '' ?
						<div className="col-sm-4">
        ...
        <div className="form-group">
          ...
          <div className="col-sm-12">
            <input ref={(ref) => this.version = ref} name="version" placeholder="Version" onChange={this.handleValueChange.bind(this)} type="number" className="form-control" value={this.state.version} required={true} min="0" inputMode="numeric"/>
          </div>
          {/*this.state.version === ''?
						<div className="col-sm-4">
