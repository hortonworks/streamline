											...
											if(o.expr){
												if(windowData.groupbykeys.indexOf(o.expr) !== -1){
													delete o.expr
                                                                                                        ...
                                                                                                        if(o.expr.search('\\[') !== -1){
                                                                                                                ...
                                                                                                                if(a.length > 1){
                                                                                                                        o.expr = a[a.length - 1] != '' ? a[a.length - 1] : a[a.length - 2];
                                                                                                                } else {
                                                                                                                        o.expr = a[0]
                                                                                                                }
                                                                                                        }
												...
												o.args = o.args[0];
                                                                                                if(o.args.search('\\[') !== -1){
                                                                                                        ...
                                                                                                        if(a.length > 1){
                                                                                                                o.args = a[a.length - 1] != '' ? a[a.length - 1] : a[a.length - 2];
                                                                                                        } else {
                                                                                                                o.args = a[0]
                                                                                                        }
                                                                                                }
												stateObj.outputFieldsArr.push(o);
                                                                        ...
                                                                        windowData.groupbykeys.map((key)=>{
                                                                                if(key.search('\\[') !== -1){
                                                                                        ...
                                                                                        if(a.length > 1){
                                                                                                key = a[a.length - 1] != '' ? a[a.length - 1] : a[a.length - 2];
                                                                                        } else {
                                                                                                key = a[0]
                                                                                        }
                                                                                }
  ...
  createSelectedKeysHierarchy = (arrKeys) => {
    ...
    generateOutputFields(fields, level){
        return fields.map((field)=>{
            let obj = { name: field.name, optional: field.optional, type: field.type};
