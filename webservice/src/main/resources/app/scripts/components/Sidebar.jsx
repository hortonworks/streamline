    ...
    return (
      <aside className="main-sidebar">
        ...
        <ul className="sidebar-menu">
          ...
          <li className={app_state.sidebar_activeKey === 4 ? 'active' : ''} onClick={this.handleClick.bind(this, 4)}><Link to="/dashboard"><i className="fa fa-dashboard"></i>{(app_state.sidebar_isCollapsed) ? <i className="alpha-icon">αlpha</i> :''} <span>Dashboard <span className="alpha-badge">αlpha</span></span></Link></li>
