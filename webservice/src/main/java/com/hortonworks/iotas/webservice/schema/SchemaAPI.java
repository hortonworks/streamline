...
public class SchemaAPI {
    ...
    public Response simulateEvolution(@Context UriInfo uriInfo) {
        ...
        String schemaJson = params.getFirst("schema");
        ...
        try {
            ...
            Map<String, Schema> appliedSchema = evolvingInstance.apply(configurationJson, Schema.fromString(schemaJson));
            return WSUtils.respond(OK, SUCCESS, appliedSchema);
    ...
    private void ensureLoadSchemaEvolvingClass(Long componentId, String schemaClass)
        ...
        // TODO: for now it's restricted to provided classes in layout module, need to apply dynamic loading?
