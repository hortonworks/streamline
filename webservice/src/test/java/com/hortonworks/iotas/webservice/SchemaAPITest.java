...
public class SchemaAPITest {
    ...
    public void testEvolveForSupportedComponent() throws Exception {
        ...
        Map<String, Object> entityMap = (Map<String, Object>) catalogResponse.getEntity();
        assertEquals(new MockEvolvingSchemaImpl().getStreamToSchemaMap(), entityMap);
    }
    ...
    public void testEvolvePlayWellWithCatalogServiceAware() {
        ...
        Map<String, Object> entityMap = (Map<String, Object>) catalogResponse.getEntity();
        assertEquals(new MockEvolvingSchemaCatalogServiceAwareImpl().getStreamToSchemaMap(), entityMap);
    }
