...
import com.hortonworks.iotas.streams.layout.component.Sink;
    ...
    private Rule buildRule(long ruleId, Condition condition, TransformAction action) {
        ...
        if (ruleId % 2 == 0) {
            ...
            Expression incr = new FunctionExpression("INCR",
                                                     "com.hortonworks.iotas.streams.runtime.storm.layout.runtime.rule.topology.RuleProcessorMockBuilder$Incr",
