...
import com.hortonworks.streamline.streams.sql.runtime.ExecutableExpression;
...
/**
 * Compiles a scalar expression ({@link RexNode}) to Java source code String.
 *
...
public class RexNodeToJavaCodeCompiler {
  ...
  enum StreamlineBuiltInMethod {
    ...
    private StreamlineBuiltInMethod(Method method, Constructor constructor, Field field) {
      this.method = method;
     ...
     * Defines a field.
     */
    StreamlineBuiltInMethod(Class clazz, String fieldName, boolean dummy) {
