...
public class StreamlineSqlTypeFactoryImpl extends JavaTypeFactoryImpl {

    public StreamlineSqlTypeFactoryImpl() {
    }

    public StreamlineSqlTypeFactoryImpl(RelDataTypeSystem typeSystem) {
        super(typeSystem);
    }
