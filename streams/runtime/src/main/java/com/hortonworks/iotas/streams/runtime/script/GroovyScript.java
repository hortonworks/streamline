...
public class GroovyScript<O> extends Script<IotasEvent, O, javax.script.ScriptEngine> {
    ...
    public GroovyScript(String expression, com.hortonworks.iotas.streams.runtime.script.engine.ScriptEngine<ScriptEngine> scriptEngine) {
        this(expression, scriptEngine, Collections.<String, Object>emptyMap());
    }

    public GroovyScript(String expression, com.hortonworks.iotas.streams.runtime.script.engine.ScriptEngine<ScriptEngine> scriptEngine, Map<String, Object> initialBindings) {
