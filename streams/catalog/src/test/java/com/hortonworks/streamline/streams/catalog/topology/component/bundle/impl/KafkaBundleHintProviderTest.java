...
import com.hortonworks.streamline.streams.catalog.service.metadata.ZookeeperMetadataService;
...
public class KafkaBundleHintProviderTest {
    ...
    public void getHintsOnClusterWithZkServiceNotAvailable() throws Exception {
        ...
        new Expectations() {{
            ...
            zookeeperMetadataService.getZookeeperServers();
            result = new ServiceNotFoundException(1L, ServiceConfigurations.ZOOKEEPER);
        }};
