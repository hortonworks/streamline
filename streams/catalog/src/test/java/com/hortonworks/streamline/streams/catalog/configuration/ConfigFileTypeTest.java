...
public class ConfigFileTypeTest {
  ...
  public void getFileTypeFromFileName() throws Exception {
    ...
    assertEquals(ConfigFileType.PROPERTIES, ConfigFileType.getFileTypeFromFileName("common.runtime.properties"));

    try {
      ConfigFileType.getFileTypeFromFileName("config");
    ...
    try {
      ConfigFileType.getFileTypeFromFileName("config.hadoop");
      fail("Expecting IllegalArgumentException");
    } catch (IllegalArgumentException e) {
      // pass
    }
