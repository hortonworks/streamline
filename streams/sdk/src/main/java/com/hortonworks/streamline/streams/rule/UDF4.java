...
/**
 * This is an interface for implementing user defined functions with four arguments.
 *
 ...
 */
public interface UDF4<O, I1, I2, I3, I4> {
    /**
     ...
     * @return the output
     */
    O evaluate(I1 input1, I2 input2, I3 input3, I4 input4);
}
