...
public class IotasTopology {
    ...
    private static final String PARSED_TUPLES_STREAM_ID = "good";
    private static final String UNPARSED_TUPLES_STREAM_ID = "bad";
    ...
    public static void main(String[] args) throws Exception {
        ...
        parserBolt.withParsedTuplesStreamId(PARSED_TUPLES_STREAM_ID);
        parserBolt.withUnparsedTuplesStreamId(UNPARSED_TUPLES_STREAM_ID);
