...
SELECT dropForeignKeysFromTable('widget_datasource_mapping');
...
SELECT dropForeignKeysFromTable('topology_source_stream_mapping');
SELECT dropForeignKeysFromTable('topology_sink');
SELECT dropForeignKeysFromTable('topology_processor');
SELECT dropForeignKeysFromTable('topology_processor_stream_mapping');
...
ALTER TABLE widget_datasource_mapping ADD CONSTRAINT "fk_widget_datasource_mapping_widget" FOREIGN KEY ("widgetId") REFERENCES widget("id");
ALTER TABLE widget_datasource_mapping ADD CONSTRAINT "fk_widget_datasource_mapping_datasource" FOREIGN KEY ("datasourceId") REFERENCES datasource("id");
...
ALTER TABLE topology_source_stream_mapping ADD CONSTRAINT "fk_topology_source_stream_mapping_topology_source" FOREIGN KEY ("sourceId", "versionId") REFERENCES topology_source("id", "versionId");
ALTER TABLE topology_source_stream_mapping ADD CONSTRAINT "fk_topology_source_stream_mapping_topology_stream" FOREIGN KEY ("streamId", "versionId") REFERENCES topology_stream("id", "versionId");
