...
DROP TABLE IF EXISTS tag_storable_map CASCADE#
...
DROP TABLE IF EXISTS topology_source_stream_map CASCADE#
...
DROP TABLE IF EXISTS topology_processor_stream_map CASCADE#
...
DROP TABLE IF EXISTS namespace_service_cluster_map CASCADE#
DROP TABLE IF EXISTS widget_datasource_mapping CASCADE#
DROP TABLE IF EXISTS widget_datasource_map CASCADE#
...
DROP TABLE IF EXISTS topology_test_run_case_sink CASCADE#
