...
CREATE TABLE "fileblob" (
  ...
  "data"        BLOB            NOT NULL,
  "timestamp"   NUMBER(19,0),
  CONSTRAINT fileblob_pk PRIMARY KEY ("name")
);
...
CREATE TABLE "topology_component" (
    ...
    "description"                 VARCHAR2(4000),
    "configData"                  CLOB,
    "reconfigure"                 NUMBER(1) DEFAULT 0 NOT NULL,
...
CREATE TABLE "service" (
  ...
  CONSTRAINT service_fk_cluster FOREIGN KEY ("clusterId") REFERENCES "cluster" ("id")
);
...
CREATE TABLE "service_configuration" (
  ...
  CONSTRAINT service_configuration_fk_srv FOREIGN KEY ("serviceId") REFERENCES "service" ("id")
);
...
CREATE TABLE "component" (
  ...
  CONSTRAINT component_fk_service FOREIGN KEY ("serviceId") REFERENCES "service" ("id")
);
...
CREATE TABLE "topology_test_run_case_source" (
  ...
  "sleepMsPerIteration"   NUMBER(19,0)    NOT NULL,
  "timestamp"             NUMBER(19,0),
