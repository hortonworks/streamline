...
CREATE TABLE IF NOT EXISTS role ("id" BIGINT NOT NULL, "name" VARCHAR(256) NOT NULL, "description" VARCHAR, "system" BOOLEAN NOT NULL, "metadata" VARCHAR, timestamp" BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
