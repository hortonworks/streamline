...
CREATE TABLE IF NOT EXISTS topology_component_bundles("id" BIGINT NOT NULL, "name" VARCHAR(256), "type" VARCHAR, "subType" VARCHAR, "streamingEngine" VARCHAR, "topologyComponentUISpecification" VARCHAR, "fieldHintProviderClass" VARCHAR, "transformationClass" VARCHAR, "timestamp"  BIGINT, "bundleJar" VARCHAR, "builtin" CHAR(4), "mavenDeps" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id"))
...
CREATE TABLE IF NOT EXISTS ruleinfos ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "topologyId" BIGINT, "name" VARCHAR, "description" VARCHAR, "streams" VARCHAR, "outputStreams" VARCHAR, "condition" VARCHAR, "sql" VARCHAR, "parsedRuleStr" VARCHAR, "projections" VARCHAR, "window" VARCHAR, "actions" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id", "versionId"))
CREATE TABLE IF NOT EXISTS branchruleinfos ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "topologyId" BIGINT, "name" VARCHAR, "description" VARCHAR, "stream" VARCHAR, "outputStreams" VARCHAR, "condition" VARCHAR, "parsedRuleStr" VARCHAR, "actions" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id", "versionId"))
CREATE TABLE IF NOT EXISTS windowinfos ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "topologyId" BIGINT, "name" VARCHAR, "description" VARCHAR, "streams" VARCHAR, "outputStreams" VARCHAR, "condition" VARCHAR, "parsedRuleStr" VARCHAR, "window" VARCHAR, "actions" VARCHAR, "projections" VARCHAR, "groupbykeys" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id", "versionId"))
...
CREATE TABLE IF NOT EXISTS clusters ("id" BIGINT NOT NULL, "name" VARCHAR, "ambariImportUrl" VARCHAR, "description" VARCHAR, "timestamp" BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
