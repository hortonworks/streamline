...
CREATE TABLE IF NOT EXISTS topology_component_bundle("id" BIGINT NOT NULL, "name" VARCHAR(256), "type" VARCHAR, "subType" VARCHAR, "streamingEngine" VARCHAR, "topologyComponentUISpecification" VARCHAR, "fieldHintProviderClass" VARCHAR, "transformationClass" VARCHAR, "timestamp"  BIGINT, "bundleJar" VARCHAR, "builtin" CHAR(5), "mavenDeps" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id"))
...
CREATE TABLE IF NOT EXISTS notifier ("id" BIGINT  NOT NULL, "name" VARCHAR, "description" VARCHAR, "jarFileName" VARCHAR, "className" VARCHAR, "timestamp"  BIGINT, "properties" VARCHAR, "fieldValues" VARCHAR, "builtin" CHAR(5), CONSTRAINT pk PRIMARY KEY ("id"))
...
CREATE TABLE IF NOT EXISTS udf ("id" BIGINT NOT NULL, "name" VARCHAR, "displayName" VARCHAR, "description" VARCHAR, "type" VARCHAR, "className" VARCHAR, "jarStoragePath" VARCHAR, "digest" VARCHAR, "argTypes" VARCHAR, "returnType" VARCHAR, "builtin" CHAR(5), CONSTRAINT pk PRIMARY KEY ("id"))
...
CREATE TABLE IF NOT EXISTS acl_entry ("id" BIGINT NOT NULL, "objectId" BIGINT NOT NULL, "objectNamespace" VARCHAR(256) NOT NULL, "sidId" BIGINT NOT NULL, "sidType" VARCHAR(256) NOT NULL, "owner" BOOLEAN NOT NULL, "grant" BOOLEAN NOT NULL, "permissions" VARCHAR(256) NOT NULL, "timestamp" BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
CREATE TABLE IF NOT EXISTS role ("id" BIGINT NOT NULL, "name" VARCHAR(256) NOT NULL, "displayName" VARCHAR(256) NOT NULL, "description" VARCHAR, "system" BOOLEAN NOT NULL, "metadata" VARCHAR, timestamp BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
...
CREATE TABLE IF NOT EXISTS user_entry ("id" BIGINT NOT NULL, "name" VARCHAR(256) NOT NULL, "email" VARCHAR(256) NOT NULL, "metadata" VARCHAR, "timestamp" BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
...
CREATE TABLE IF NOT EXISTS topology_test_run_case ("id" BIGINT NOT NULL, "name" VARCHAR(256) NOT NULL, "topologyId" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "timestamp" BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
CREATE TABLE IF NOT EXISTS topology_test_run_case_source ("id" BIGINT NOT NULL, "testCaseId" BIGINT NOT NULL, "sourceId" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "records" VARCHAR NOT NULL, "occurrence" BIGINT NOT NULL, "timestamp" BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
CREATE TABLE IF NOT EXISTS topology_test_run_case_sink ("id" BIGINT NOT NULL, "testCaseId" BIGINT NOT NULL, "sinkId" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "records" VARCHAR NOT NULL, "timestamp" BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
CREATE TABLE IF NOT EXISTS topology_test_run_histories ("id" BIGINT NOT NULL, "topologyId" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "testCaseId" BIGINT NOT NULL, "finished" CHAR(5) NOT NULL, "success" CHAR(5) NOT NULL, "expectedOutputRecords" VARCHAR, "actualOutputRecords" VARCHAR, "matched" CHAR(5), "eventLogFilePath" VARCHAR NOT NULL, "startTime" BIGINT, "finishTime" BIGINT, "timestamp" BIGINT, CONSTRAINT pk PRIMARY KEY ("id"))
