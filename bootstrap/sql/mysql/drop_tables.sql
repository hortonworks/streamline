...
DROP TABLE IF EXISTS tag_storable_map#
...
DROP TABLE IF EXISTS topology_source_stream_map#
...
DROP TABLE IF EXISTS topology_processor_stream_map#
...
DROP TABLE IF EXISTS namespace_service_cluster_map#
DROP TABLE IF EXISTS widget_datasource_mapping#
DROP TABLE IF EXISTS widget_datasource_map#
