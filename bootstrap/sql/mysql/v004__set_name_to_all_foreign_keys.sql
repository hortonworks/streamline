...
CALL dropForeignKeysFromTable('widget_datasource_mapping');
...
CALL dropForeignKeysFromTable('topology_source_stream_mapping');
CALL dropForeignKeysFromTable('topology_sink');
CALL dropForeignKeysFromTable('topology_processor');
CALL dropForeignKeysFromTable('topology_processor_stream_mapping');
