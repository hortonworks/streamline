...
function update_bundles {
    # === Source ===
    add_topology_component_bundle /streams/componentbundles/SOURCE ${component_dir}/sources/kafka-flink-source-topology-component.json KAFKA
    # === Processor ===

    # === Sink ===
    add_topology_component_bundle /streams/componentbundles/SINK ${component_dir}/sinks/kafka-flink-sink-topology-component.json KAFKA
    # === Topology ===
    add_topology_component_bundle /streams/componentbundles/TOPOLOGY ${component_dir}/topology/flink-topology-component.json TOPOLOGY
    # === Service Bundle ===
