...
echo "stddev"
curl -s -X POST "http://${host}:${port}/api/v1/catalog/streams/udfs" -F udfJarFile=@./udf-jars/streamline-functions-0.1.0.jar -F udfConfig='{"name":"STDDEV", "displayName": "STDDEV", "description": "Standard deviation", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Stddev"};type=application/json'
echo

echo "stddevp"
curl -s -X POST "http://${host}:${port}/api/v1/catalog/streams/udfs" -F udfJarFile=@./udf-jars/streamline-functions-0.1.0.jar -F udfConfig='{"name":"STDDEVP", "displayName": "STDDEVP", "description": "Population standard deviation", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Stddevp"};type=application/json'
echo

echo "variance"
curl -s -X POST "http://${host}:${port}/api/v1/catalog/streams/udfs" -F udfJarFile=@./udf-jars/streamline-functions-0.1.0.jar -F udfConfig='{"name":"VARIANCE", "displayName": "VARIANCE", "description": "Variance", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Variance"};type=application/json'
echo

echo "variancep"
curl -s -X POST "http://${host}:${port}/api/v1/catalog/streams/udfs" -F udfJarFile=@./udf-jars/streamline-functions-0.1.0.jar -F udfConfig='{"name":"VARIANCEP", "displayName": "VARIANCEP", "description": "Population variance", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Variancep"};type=application/json'
echo

echo "avg"
curl -s -X POST "http://${host}:${port}/api/v1/catalog/streams/udfs" -F udfJarFile=@./udf-jars/streamline-functions-0.1.0.jar -F udfConfig='{"name":"MEAN", "displayName": "AVG","description": "Average", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Mean"};type=application/json'
echo

echo "sum"
curl -s -X POST "http://${host}:${port}/api/v1/catalog/streams/udfs" -F udfJarFile=@./udf-jars/streamline-functions-0.1.0.jar -F udfConfig='{"name":"NUMBERSUM", "displayName": "SUM","description": "Sum", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.NumberSum"};type=application/json'
echo

echo "collectlist"
curl -s -X POST "http://${host}:${port}/api/v1/catalog/streams/udfs" -F udfJarFile=@./udf-jars/streamline-functions-0.1.0.jar -F udfConfig='{"name":"COLLECTLIST", "displayName": "COLLECTLIST", "description": "Collect", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.CollectList"};type=application/json'
echo

echo "topn"
curl -s -X POST "http://${host}:${port}/api/v1/catalog/streams/udfs" -F udfJarFile=@./udf-jars/streamline-functions-0.1.0.jar -F udfConfig='{"name":"TOPN", "displayName": "TOPN", "description": "Top N", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Topn"};type=application/json'
echo
