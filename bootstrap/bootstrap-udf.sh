...
echo "stddev"
curl -s -X POST 'http://localhost:8080/api/v1/catalog/streams/udfs' -F udfJarFile=@${dir}/streams/functions/target/streams-functions-0.1.0-SNAPSHOT.jar -F udfConfig='{"name":"STDDEV", "description": "Standard deviation", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Stddev"};type=application/json'
echo

echo "stddevp"
curl -s -X POST 'http://localhost:8080/api/v1/catalog/streams/udfs' -F udfJarFile=@${dir}/streams/functions/target/streams-functions-0.1.0-SNAPSHOT.jar -F udfConfig='{"name":"STDDEVP", "description": "Population standard deviation", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Stddevp"};type=application/json'
echo

echo "variance"
curl -s -X POST 'http://localhost:8080/api/v1/catalog/streams/udfs' -F udfJarFile=@${dir}/streams/functions/target/streams-functions-0.1.0-SNAPSHOT.jar -F udfConfig='{"name":"VARIANCE", "description": "Variance", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Variance"};type=application/json'
echo

echo "variancep"
curl -s -X POST 'http://localhost:8080/api/v1/catalog/streams/udfs' -F udfJarFile=@${dir}/streams/functions/target/streams-functions-0.1.0-SNAPSHOT.jar -F udfConfig='{"name":"VARIANCEP", "description": "Population variance", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Variancep"};type=application/json'
echo

echo "collectlist"
curl -s -X POST 'http://localhost:8080/api/v1/catalog/streams/udfs' -F udfJarFile=@${dir}/streams/functions/target/streams-functions-0.1.0-SNAPSHOT.jar -F udfConfig='{"name":"COLLECTLIST", "description": "Collect", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.CollectList"};type=application/json'
echo

echo "topn"
curl -s -X POST 'http://localhost:8080/api/v1/catalog/streams/udfs' -F udfJarFile=@${dir}/streams/functions/target/streams-functions-0.1.0-SNAPSHOT.jar -F udfConfig='{"name":"TOPN", "description": "Top N", "type":"AGGREGATE", "className":"org.apache.streamline.streams.udaf.Topn"};type=application/json'
echo
