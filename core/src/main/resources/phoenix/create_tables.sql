...
CREATE TABLE IF NOT EXISTS topology_sources ("id" BIGINT NOT NULL, "topologyId" BIGINT, "name" VARCHAR, "type" VARCHAR, "configData" VARCHAR, "outputstreamidsdata" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id"))
...
CREATE TABLE IF NOT EXISTS topology_processors ("id" BIGINT NOT NULL, "topologyId" BIGINT, "name" VARCHAR, "type" VARCHAR, "configData" VARCHAR, "outputstreamidsdata" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id"))
