...
public interface Notifier {
     ...
     * it to the external system (e.g. sending an email).
     * </p>
     ...
     * ‘Notification’ object. The Fields can be set via the yaml
     * config for now. The default values for the fields could
