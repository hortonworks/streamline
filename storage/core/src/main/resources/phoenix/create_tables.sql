...
CREATE TABLE IF NOT EXISTS streaminfo ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "topologyId" BIGINT, "streamId" VARCHAR(256), "fieldsData" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id", "versionId"))
