...
CREATE TABLE IF NOT EXISTS topologies ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "name" VARCHAR (256), "config" VARCHAR, "timestamp"  BIGINT, CONSTRAINT pk PRIMARY KEY ("id", "versionId"))
...
CREATE TABLE IF NOT EXISTS topology_editor_metadata ("topologyId" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "data" VARCHAR, "timestamp"  BIGINT, CONSTRAINT pk PRIMARY KEY ("topologyId"))
...
CREATE TABLE IF NOT EXISTS topology_components ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "topologyId" BIGINT, "topologyComponentBundleId" BIGINT, "name" VARCHAR, "configData" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id", "versionId"))
CREATE TABLE IF NOT EXISTS topology_sources ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "topologyId" BIGINT, "topologyComponentBundleId" BIGINT, "name" VARCHAR, "configData" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id", "versionId"))
...
CREATE TABLE IF NOT EXISTS topology_sinks ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "topologyId" BIGINT, "topologyComponentBundleId" BIGINT, "name" VARCHAR, "configData" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id", "versionId"))
CREATE TABLE IF NOT EXISTS topology_processors ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "topologyId" BIGINT, "topologyComponentBundleId" BIGINT, "name" VARCHAR, "configData" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id", "versionId"))
...
CREATE TABLE IF NOT EXISTS ruleinfos ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "topologyId" BIGINT, "name" VARCHAR, "description" VARCHAR, "streams" VARCHAR, "condition" VARCHAR, "sql" VARCHAR, "parsedRuleStr" VARCHAR, "window" VARCHAR, "actions" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id", "versionId"))
CREATE TABLE IF NOT EXISTS branchruleinfos ("id" BIGINT NOT NULL, "versionId" BIGINT NOT NULL, "topologyId" BIGINT, "name" VARCHAR, "description" VARCHAR, "stream" VARCHAR, "condition" VARCHAR, "parsedRuleStr" VARCHAR, "actions" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id"))
