...
CREATE TABLE IF NOT EXISTS topology_components ("id" BIGINT NOT NULL, "topologyId" BIGINT, "topologyComponentBundleId" BIGINT, "name" VARCHAR, "configData" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id"))
CREATE TABLE IF NOT EXISTS topology_sources ("id" BIGINT NOT NULL, "topologyId" BIGINT, "topologyComponentBundleId" BIGINT, "name" VARCHAR, "configData" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id"))
...
CREATE TABLE IF NOT EXISTS topology_sinks ("id" BIGINT NOT NULL, "topologyId" BIGINT, "topologyComponentBundleId" BIGINT, "name" VARCHAR, "configData" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id"))
CREATE TABLE IF NOT EXISTS topology_processors ("id" BIGINT NOT NULL, "topologyId" BIGINT, "topologyComponentBundleId" BIGINT, "name" VARCHAR, "configData" VARCHAR, CONSTRAINT pk PRIMARY KEY ("id"))
