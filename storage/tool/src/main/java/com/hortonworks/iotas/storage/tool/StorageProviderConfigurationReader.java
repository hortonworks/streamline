package com.hortonworks.iotas.storage.tool;
...
public class StorageProviderConfigurationReader {
  public static final String JDBC_STORAGE_MANAGER_CLASS = "com.hortonworks.iotas.storage.impl.jdbc.JdbcStorageManager";
