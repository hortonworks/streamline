...
/**
 * Secondary index mapping for ruleId + status to device notification
 */
public class RuleStatusDeviceNotificationMapper extends NotificationStatusIndexMapper {
    /**
     * The HBase index table
     */
    private static final String TABLE_NAME = "Rule_Status_Device_Notification";
