  ...
  render() {
    ...
    >
      <div className="p-group">
        <p>
          <a href="https://github.com/implydata/imply-pivot" target='_blank'>Pivot</a> (version {version}) is open source under
          the <a href="https://github.com/implydata/imply-pivot/blob/master/LICENSE" target='_blank'>Apache 2.0</a> license.
        ...
        <p>
          For bug reports please create an issue on <a href="https://github.com/implydata/imply-pivot/issues" target='_blank'>GitHub</a>.
        </p>
      </div>
