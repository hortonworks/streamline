...
#curl -X POST http://localhost:8080/api/v1/catalog/datasources --data @dataset -H "Content-Type: application/json" &&\
#curl -X POST http://localhost:8080/api/v1/catalog/feeds --data @dataset-datafeed -H "Content-Type: application/json" &&\
